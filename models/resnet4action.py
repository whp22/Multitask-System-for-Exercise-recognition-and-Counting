...
def _block_name_base(stage, block, name = 'action'):
...
def resnet18(input_shape=(224,224,16), classes = 7, name = 'action'):
    ...
    x = Dense(units=classes, activation='softmax',kernel_initializer="he_normal",name = appstr(name, 'd3'))(d2)
    res18 = Model(input,x,name = appstr(name, 'r18'))
    return res18


def  resnet34(input_shape=(224,224,16), classes = 7, name = 'action'):
    ...
    d2 = Dense(28, activation='relu', kernel_initializer='he_normal',name = appstr(name, 'd2'))(d1)
    x = Dense(units=classes,activation='softmax', kernel_initializer="he_normal", name = appstr(name, 'd3'))(d2)
    res34 = Model(input, x, name = appstr(name, 'r34'))
    return res34


def resnet50(input_shape=(224,224,16), classes = 7, name = 'action'):
    ...
    d5 = Dense(7, activation='softmax', kernel_initializer='he_normal', name = appstr(name, 'd5'))(d4)
    # d6 = Dense(1, activation='linear', name = appstr(name, 'd6'))(d5)

    res50 = Model(input, d5, name = appstr(name, 'r1'))
    # res50.summary()
    return res50

def resnet101(input_shape=(224,224,16), classes = 7, name = 'action'):
    ...
    res101 = Model(input, d5, name = appstr(name, 'r1'))
    return res101
